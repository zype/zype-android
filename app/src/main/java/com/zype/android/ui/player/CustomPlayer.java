...
//    private Id3MetadataListener id3MetadataListener;
    ...
    public CustomPlayer(Context context, RendererBuilder rendererBuilder) {
        mContext = context;
...
//    }
     ...
     *
     * @param renderers      Renderers indexed by {@link CustomPlayer} TYPE_* constants. An
     *                       individual
...
//
    ...
    public void onDroppedFrames(int count, long elapsed) {
        if (infoListener != null) {
            ...
            Logger.d("onDroppedFrames count" + count + " elapsed" + elapsed);
            if (ZypeApp.isLiveTest) {
                Toast.makeText(mContext, "onDroppedFrames count" + count + " elapsed:" + elapsed, Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    public void onDownstreamFormatChanged(int sourceId, Format format, int trigger,
        ...
        if (format != null) {
            Logger.d("video size: " + format.width + "x" + format.height + " Codec:" + format.codecs + " Bitrate:" + format.bitrate);
            if (ZypeApp.isLiveTest) {
                Toast.makeText(mContext, "video size: " + format.width + "x" + format.height + " Codec:" + format.codecs + " Bitrate:" + format.bitrate, Toast.LENGTH_SHORT).show();
            }
        }
        if (infoListener == null) {
            return;
